 ...
 <!-- Navbar section start-->
    <nav class="navbar navbar-expand-lg navbar-dark menu shadow fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="./assets/OgranicMe.netlify.app.raw2.png" alt="logo image" class="img-fluid" >
        </a>
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
      ...
      <li><a class="dropdown-item" href="#">Another action 4</a></li>
      <li><a class="dropdown-item" href="#">Another action 5</a></li>
      <li><a class="dropdown-item" href="#">Another action 6</a></li>
...
.menu {
    background: linear-gradient(to right, rgba(3, 157, 247, 0.95), rgba(0, 240, 208, 0.95));
}
</style>
